...
const GetTransactionsSchema = z
  .object({
    ...
    type: z.preprocess(commaSplit, z.array(TransactionTypeSchema)).optional(),
    account_id: z.preprocess(commaSplit, z.array(z.uuid())).optional(),
    budget_item_id: z.preprocess(commaSplit, z.array(z.uuid())).optional(),
